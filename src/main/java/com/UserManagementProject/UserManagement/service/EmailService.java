...
import com.UserManagementProject.UserManagement.constant.EmailConstant;
...
public class EmailService {
	...
	private Message createEmail(String firstName ,String password, String email) throws MessagingException {
		...
		message.setRecipients(RecipientType.CC, InternetAddress.parse(EmailConstant.CC_EMAIL,false));
